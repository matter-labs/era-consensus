...
use crate::{gossip::ValidatorAddrsWatch, io, pool::PoolWatch, Config, StreamValues};
...
pub(crate) struct Network {
    ...
    pub(crate) inbound: PoolWatch<node::PublicKey, Arc<StreamValues>>,
    /// Currently open outbound connections.
    pub(crate) outbound: PoolWatch<node::PublicKey, Arc<StreamValues>>,
