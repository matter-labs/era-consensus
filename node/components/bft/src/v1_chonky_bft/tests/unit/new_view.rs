...
async fn new_view_sanity() {
    ...
    scope::run!(ctx, |ctx, s| async {
        ...
        let mut commit_qc_1 = validator::v1::CommitQC::new(commit_1.clone(), util.validators());
        ...
        let new_view_1 = validator::v1::ReplicaNewView {
            justification: validator::v1::ProposalJustification::Commit(commit_qc_1.clone()),
        };

        let commit_2 = validator::v1::ReplicaCommit {
        ...
        let mut commit_qc_2 = validator::v1::CommitQC::new(commit_2.clone(), util.validators());
        for key in &util.keys {
            commit_qc_2
                .add(
        ...
        let new_view_2 = validator::v1::ReplicaNewView {
            justification: validator::v1::ProposalJustification::Commit(commit_qc_2.clone()),
        };

        let timeout = validator::v1::ReplicaTimeout {
            view: commit_2.view.next(),
            high_vote: None,
            high_qc: Some(commit_qc_2.clone()),
        };
        let mut timeout_qc = validator::v1::TimeoutQC::new(timeout.view);
        for key in &util.keys {
            timeout_qc
                .add(
        ...
        let new_view_3 = validator::v1::ReplicaNewView {
            justification: validator::v1::ProposalJustification::Timeout(timeout_qc.clone()),
        };
