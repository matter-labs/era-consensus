...
async fn proposal_old_view() {
    ...
    scope::run!(ctx, |ctx, s| async {
        ...
        util.replica.phase = validator::v2::Phase::Commit;
        ...
        util.replica.phase = validator::v2::Phase::Timeout;
        ...
        util.replica.phase = validator::v2::Phase::Prepare;
...
async fn proposal_missing_previous_payload() {
    ...
    scope::run!(ctx, |ctx, s| async {
        ...
        let proposal = validator::v2::LeaderProposal {
            proposal_payload: Some(ctx.rng().gen()),
            justification: validator::v2::ProposalJustification::Commit(
